...
//     color: "bg-purple-600",
//     description:
//       "Assisted in facilitating Data Structures & Algorithms lab sessions, guided students through programming exercises, and supported practical learning. Received positive feedback for reliability, mentoring, and helping students complete lab tasks successfully.",
//     technologies: [
//       "C++",
//       "Data Structures",
//       "Algorithms",
...
//   },
//   {
//     title: "Trainee Frontend Engineer",
//     company: "Fista Solutions",
//     period: "2024",
//     icon: <FaBriefcase />,
//     color: "bg-blue-600",
//     description:
//       "Developed responsive web applications using React.js, Next.js, TypeScript, and Tailwind CSS. Built reusable UI components, integrated REST APIs, collaborated with the development team, and improved user experience.",
//     technologies: [
//       "React.js",
//       "Next.js",
//       "TypeScript",
...
//     company: "AI-Powered ANPRS System",
//     period: "2025",
//     icon: <FaLaptopCode />,
//     color: "bg-green-600",
//     description:
//       "Designed and developed an AI-powered Automated Number Plate Recognition System using Python, Flask, EasyOCR, Next.js, PostgreSQL, and Roboflow for intelligent vehicle entry and exit management.",
//     technologies: [
//       "Python",
//       "Flask",
//       "EasyOCR",
...
//             My professional journey, internship experience, and major projects.
//           </p>
...
//             <div className="absolute left-6 md:left-1/2 top-0 -translate-x-1/2 w-1 h-full bg-blue-200 rounded-full"></div>
...
//                     scale: 1.02,
//                   }}
//                   className="ml-20 md:ml-0 w-full md:w-[45%] bg-transparent border border-gray-100 rounded-2xl shadow-lg p-8"
//                 >
...
//                 <div
//                   className={`absolute left-6 md:left-1/2 -translate-x-1/2 w-14 h-14 rounded-full ${item.color} text-white flex items-center justify-center text-2xl shadow-xl z-10`}
//                 >
//                   {item.icon}
//                 </div>
