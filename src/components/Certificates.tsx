...
//     type: "education",
//     description:
//       "Completed a Bachelor's degree with a strong foundation in Software Engineering, Artificial Intelligence, Databases, Computer Vision, and Full Stack Web Development. Successfully developed an AI-powered ANPRS as the Final Year Project.",
//     pdf: "",
//   },
...
//     type: "teaching",
//     description:
//       "Assisted students during Data Structures & Algorithms laboratory sessions, explained programming concepts, and supported instructors in conducting practical labs.",
...
//     type: "internship",
//     description:
//       "Worked on responsive web applications using React.js, Next.js, TypeScript, Tailwind CSS, and API integration while collaborating with a professional development team.",
...
//     type: "education",
//     description:
//       "Currently pursuing MS Computer Science with research interests in Artificial Intelligence, Computer Vision, Machine Learning, Smart Campus Technologies, and Full Stack Development.",
//     pdf: "",
//   },
// ];
...
//           <p className="text-center text-gray-500 mt-4 mb-20 max-w-3xl mx-auto">
//             My academic journey, teaching experience, and professional
//             achievements that have shaped my career as a Frontend Developer.
//           </p>
...
//             <div className="absolute left-6 md:left-1/2 top-0 h-full w-1 bg-blue-200 -translate-x-1/2" />
...
//                           href={item.pdf}
//                           download
//                           className="flex items-center gap-2 border border-blue-600 text-blue-600 px-5 py-3 rounded-xl hover:bg-blue-600 hover:text-white transition"
//                         >
//                           <FaDownload />
